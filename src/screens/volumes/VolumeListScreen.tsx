...
const freeActions = [{ label: "Delete", icon: "🗑", destructive: true }];
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <VolumeRow
              volume={item}
              onPress={() =>
                openSheet(item, item.name, getActions(item), (i) =>
                  handleAction(i, getActions(item), item),
                )
              }
              onLongPress={() =>
                openSheet(item, item.name, getActions(item), (i) =>
          ...
          ListEmptyComponent={
            <Text style={styles.empty}>No volumes found</Text>
          }
        />
      )}
  ...
  return (
    ...
    >
      ...
      <View
        style={[
          styles.badge,
          isAttached ? styles.badgeAttached : styles.badgeFree,
        ]}
      >
        <Text
          style={[
            styles.badgeText,
            { color: isAttached ? colors.primary : colors.success },
          ]}
        >
