        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <TouchableOpacity
              style={styles.row}
              onPress={() =>
                navigation.navigate("LoadBalancerDetail", { lbId: item.id })
              }
              activeOpacity={0.7}
            >
              <View style={styles.rowLeft}>
                ...
                <Text style={styles.lbMeta}>
                  {item.load_balancer_type.name} · {item.location.city} ·{" "}
          ...
          ListEmptyComponent={
            <Text style={styles.empty}>No load balancers found</Text>
          }
        />
      )}
