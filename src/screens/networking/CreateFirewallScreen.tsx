...
export default function CreateFirewallScreen({ navigation }: Props) {
  ...
  const handleCreate = async () => {
    if (!name.trim()) {
      Alert.alert("Error", "Enter a firewall name");
      return;
    }
              ...
              <View style={styles.segmentRow}>
                {DIRECTIONS.map((dir) => (
                  <TouchableOpacity
                    ...
                    style={[
                      styles.segment,
                      rule.direction === dir && styles.segmentActive,
                    ]}
                  ...
                  >
                    <Text
                      style={[
                        styles.segmentText,
                        rule.direction === dir && styles.segmentTextActive,
                      ]}
                    >
              ...
              <View style={styles.segmentRow}>
                {PROTOCOLS.map((p) => (
                  <TouchableOpacity
                    ...
                    style={[
                      styles.segment,
                      rule.protocol === p && styles.segmentActive,
                    ]}
                  ...
                  >
                    <Text
                      style={[
                        styles.segmentText,
                        rule.protocol === p && styles.segmentTextActive,
                      ]}
                    >
                      {p.toUpperCase()}
                    </Text>
