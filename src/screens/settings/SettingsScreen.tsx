    ...
    try {
      ...
      if (biometricType !== "none") {
        const ok = await authenticateWithBiometrics(
          "Authenticate to view API token",
        );
        if (!ok) {
          Haptics.error();
          Alert.alert(
      ...
      <ScrollView contentContainerStyle={styles.content}>
            ...
            <View style={styles.segmentRow}>
              {REFRESH_INTERVALS.map(({ label, value }) => (
                <TouchableOpacity
                  ...
                  style={[
                    styles.segment,
                    refreshInterval === value && styles.segmentActive,
                  ]}
                  onPress={() => {
                    Haptics.light();
                ...
                >
                  <Text
                    style={[
                      styles.segmentText,
                      refreshInterval === value && styles.segmentTextActive,
                    ]}
                  >
                    {label}
                  </Text>
          ...
          >
            ...
            <View style={{ flexDirection: "row", gap: Spacing.sm }}>
              <TouchableOpacity
                style={[
                  styles.button,
                  { flex: 1, marginTop: 0, paddingVertical: Spacing.sm + 2 },
                ]}
        ...
        <View style={styles.card}>
          ...
          <SettingsRow
            ...
            onPress={() =>
              Linking.openURL(
                "https://github.com/GabrielKanev/Hetzner-OpenControl",
              )
            }
