...
const IMAGE_ACTIONS = [{ label: "Delete", icon: "🗑", destructive: true }];
...
export default function ImagesScreen() {
    ...
    return (
      ...
      >
        ...
        <View
          style={[
            styles.statusBadge,
            item.status === "available" ? styles.badgeOk : styles.badgePending,
          ]}
        >
          <Text
            style={[
  ...
  const emptyIcon =
    tab === "snapshot" ? "camera-off-outline" : "backup-restore";
  const emptyText =
    tab === "snapshot"
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.tabs}>
        ...
        >
          <Text
            style={[styles.tabText, tab === "snapshot" && styles.tabTextActive]}
          >
        ...
        >
          <Text
            style={[styles.tabText, tab === "backup" && styles.tabTextActive]}
          >
      ...
      <ActionSheetModal
        ...
        title={
          selected
            ? selected.description || selected.name || `Image #${selected.id}`
            : undefined
        }
        options={IMAGE_ACTIONS}
        onSelect={(i) => {
